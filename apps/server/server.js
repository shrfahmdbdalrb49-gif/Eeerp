...
app.get('/health', (req, res) => res.json({ ok: true, name: 'Sharaf ERP API', build: 'v79e', ts: new Date().toISOString() }))
app.get('/api/health', (req, res) => res.json({ ok: true, name: 'Sharaf ERP API', build: 'v79e', ts: new Date().toISOString() }))
